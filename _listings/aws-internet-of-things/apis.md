...
- name: AWS Internet of Things API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rules/master/_listings/aws-internet-of-things/action-replacetopicrule-get.md
- name: AWS Internet of Things API Disable Topic Rule
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rules/master/_listings/aws-internet-of-things/action-disabletopicrule-get.md
x-common:
- type: x-blog

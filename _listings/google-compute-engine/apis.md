...
- name: Google Compute Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rules/master/_listings/google-compute-engine/project-aggregated-forwardingrules-get.md
- name: Google Compute Engine API Get Forwarding Rules
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rules/master/_listings/google-compute-engine/project-aggregated-forwardingrules-get-postman.md
x-common:
- type: x-code

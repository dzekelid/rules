...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/rules/master/_listings/akamai/cloudlets-api-v2-policies-policyid-versions-version-rules-akaruleid-put.md
x-common:
- type: x-base

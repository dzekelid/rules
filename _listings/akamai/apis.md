...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/rules/master/_listings/akamai/papi-v0-properties-propertyid-versions-propertyversion-rules-contractid,groupid-get.md
x-common:
- type: x-base
